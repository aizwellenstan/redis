...
changeArray = [
  ...
  { objectId: "53402a68-06cd-43d7-b07d-b90844ed6f49", min: 219.6, max: 220.4 }, // ACBB1電表電壓V1
  { objectId: "d2825cd1-8f53-4d9b-9090-689294c73d32", min: 219.6, max: 220.4 }, // ACBB1電表電壓V2
  { objectId: "cbace30c-50c2-47fa-8a67-d5501726663c", min: 219.6, max: 220.4 }, // ACBB1電表電壓V3
  { objectId: "88cb061c-5ffc-42dd-a59a-a3063b86af7f", min: 0.3, max: 0.5 }, // ACBB1電表電流I1
  { objectId: "e90df963-e309-4981-b254-53f24a24d549", min: 0.3, max: 0.5 }, // ACBB1電表電流I2
  { objectId: "2981dd6d-6f75-496a-a9e6-374d493bbd31", min: 0.3, max: 0.5 }, // ACBB1電表電流I3
  { objectId: "fd4760e1-3912-48d1-88bf-3e4f17455613", min: 0.8, max: 1.1 }, // ACBB1電表電功率KW
  { objectId: "8b3712c9-eec3-4cf1-bea4-3868c7ae17e5", min: 0.8, max: 0.8 }, // ACBB1電表功因Pf
  { objectId: "843d7623-488a-4d93-a8b5-b13faf8ab813", min: 59.8, max: 60.1 }, // ACBB1電表頻率Hz
  { objectId: "f74346d5-3061-4269-9059-5cd3dd37a055", min: 219.6, max: 220.4 }, // ACBB2電表電壓V1
  { objectId: "0c4e11e6-8f41-4ac0-8f61-c1dcb97a092b", min: 219.6, max: 220.4 }, // ACBB2電表電壓V2
  { objectId: "7825ec50-ec55-4ba5-89dc-09d7a3005c03", min: 219.6, max: 220.4 }, // ACBB2電表電壓V3
  { objectId: "02273ca2-0fd4-4fa3-bc69-205147daa8ac", min: 1.0, max: 1.2 }, // ACBB2電表電流I1
  { objectId: "7c19e6fb-b1c3-49d2-8f7e-f69b1e228c08", min: 1.2, max: 1.3 }, // ACBB2電表電流I2
  { objectId: "7a648611-9823-481e-a076-f3856cd3f874", min: 1.2, max: 1.5 }, // ACBB2電表電流I3
  { objectId: "82846ee6-d61a-439e-af6a-00ac836fd37f", min: 1.1, max: 1.3 }, // ACBB2電表電功率KW
  { objectId: "d124d2e3-501e-461c-951e-84e3a9ee2be4", min: 0.8, max: 0.8 }, // ACBB2電表功因Pf
  { objectId: "e66c1d8b-7828-402b-ab65-88e99dbb7045", min: 59.8, max: 60.1 }, // ACBB2電表頻率Hz
  { objectId: "01a308db-90c9-45b5-a6dd-cbcc23a9a7ec", min: 219.6, max: 220.4 }, // 發電機3電壓V1
  { objectId: "34162679-dc25-419a-8d06-7cc9fa054466", min: 219.6, max: 220.4 }, // 發電機3電壓V2
  { objectId: "6222709e-5560-4cea-ba98-ebae51a62a06", min: 219.6, max: 220.4 }, // 發電機3電壓V3
  ...
  { objectId: "07a59ed6-cef8-4c43-8626-66d8df59c6a9", min: 14.1, max: 14.1 }, // 發電機3電功率KW
